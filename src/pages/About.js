        ...
        <section className="section-padding bg-neutral-50">
          <div className="container-custom">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16">
              <div>
                <h3 className="text-xl md:text-2xl lg:text-3xl font-heading font-bold text-primary-dark mb-6">
                  Our Mission
                </h3>
                <p className="text-base md:text-lg leading-relaxed text-neutral-500">
        ...
        <section className="section-padding">
          <div className="container-custom">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
              <div className="bg-neutral-50 p-8 md:p-10 rounded-xl text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
                <div className="w-16 h-16 md:w-20 md:h-20 bg-primary-dark rounded-full flex items-center justify-center mx-auto mb-5 md:mb-6">
          ...
          <div className="container-custom">
            ...
            <div className="space-y-6 md:space-y-8 max-w-4xl mx-auto">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
                <div className="bg-primary-dark text-white px-6 py-3 rounded-lg font-bold text-lg min-w-[100px] text-center flex-shrink-0">
                  1950
                </div>
                <p className="text-base md:text-lg leading-relaxed text-neutral-500">
